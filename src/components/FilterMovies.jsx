...
//       console.log(
//         " Fetching:",
//         `https://assignment-10-movie-server.vercel.app/filter-movies?${params}`
//       );

//       const res = await fetch(`https://assignment-10-movie-server.vercel.app/filter-movies?${params}`);
...
const FilterMovies = () => {
  ...
  return (
    <div className="mx-auto px-4 bg-gray-900 py-8">
      ...
      {/* Filter Controls */}
      <div className="flex flex-col sm:flex-wrap sm:flex-row gap-4 justify-center items-center text-white mb-8">
        {/* Genres */}
        <div className="flex flex-wrap justify-center gap-3">
          <label className="font-semibold w-full text-center sm:w-auto sm:text-left">
            Genres:
          </label>
          {genres.map((genre) => (
            <label
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          <div>
            ...
            <input
              ...
              value={minRating}
              onChange={(e) => setMinRating(e.target.value)}
              className="border border-gray-500 bg-gray-800 text-white p-1 rounded w-20 sm:w-24"
            />
          </div>
          <div>
            <label className="font-semibold mr-2">Max Rating:</label>
        ...
        <button
          onClick={handleFilter}
          className="w-full sm:w-auto bg-gradient-to-r from-pink-500 to-red-600 hover:from-red-600 hover:to-pink-500 text-white font-semibold rounded-full py-2 px-6 mt-3 sm:mt-0 transition-all duration-300"
        >
          Apply Filter
        </button>
      </div>
